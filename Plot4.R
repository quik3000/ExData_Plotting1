...
## Plot "multiple base plots" to graphic device (PNG)
...
with(datafield, {
  ...
  plot(my_date_time, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
  ...
  plot(my_date_time, Voltage, type = "l", xlab = "datetime")
  
  plot(my_date_time, Global_reactive_power, type = "l", xlab = "datetime")
